...
class ProjectModel {
  ...
  factory ProjectModel.fromJson(Map<String, dynamic> json) => ProjectModel(
    ...
    linkedEventIds: _strings(
      json['linked_event_ids'] ?? json['linkedEventIds'],
    ),
    linkedAssetIds: _strings(
      json['linked_asset_ids'] ?? json['linkedAssetIds'],
    ),
    linkedReminderIds: _strings(
      json['linked_reminder_ids'] ?? json['linkedReminderIds'],
    ),
...
class GoalModel {
  ...
  factory GoalModel.fromJson(Map<String, dynamic> json) => GoalModel(
    ...
    priority: '${json['priority'] ?? 'medium'}',
    category: '${json['category'] ?? 'general'}',
    linkedProjectIds: _strings(
      json['linked_project_ids'] ?? json['linkedProjectIds'],
    ),
    archived: json['archived'] as bool? ?? false,
  );
  Map<String, dynamic> toJson() => {
...
class ProjectTemplateModel {
  ...
  factory ProjectTemplateModel.fromJson(Map<String, dynamic> json) =>
      ProjectTemplateModel(
        ...
        category: '${json['category'] ?? 'general'}',
        description: '${json['description'] ?? ''}',
        milestoneNames: _strings(
          json['milestone_names'] ?? json['milestoneNames'],
        ),
      );
}
